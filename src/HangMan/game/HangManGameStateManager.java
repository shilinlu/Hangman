...
public class HangManGameStateManager {
    ...
    /**
     * Finds the completed game that the player won that required the fewest
     * guesses before correctly guessing the secret word.
     *
     * @return The completed game that the player won requiring the fewest
     * guesses.
     */
     ...
     * example, 'hello' would return true because it has repeating 'l' letters.
     * 'great' would return false because it has no repeating letters.
     */
     ...
     *
     * @param initWordList This String contains all the words to be loaded into
     * the dictionary, separated by newline characters.
     */
    ...
    /**
     * This method processes the guess letter, checking to make sure it's in the
     * secret word and then updating the game accordingly.
     *
