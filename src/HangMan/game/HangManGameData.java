...
public class HangManGameData {
     ...
     *
     * @param guess Word to test to see if it's in this game's secret word.
     * @param oldGuessMatch the old so-far-guessed string
     ...
     *
     * @param guess Word to test to see if it's this game's secret word.
