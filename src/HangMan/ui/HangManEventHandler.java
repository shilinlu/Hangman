...
public class HangManEventHandler {
    ...
    /**
     * This method responds to when the user requests to go the help screen's
     * home page. It responds by loading that page.
     */
